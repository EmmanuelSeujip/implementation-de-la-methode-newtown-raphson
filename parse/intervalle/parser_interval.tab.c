...
#define YYSTYPE         INTERVAL_STYPE
/* Substitute the variable and function names.  */
#define yyparse         interval_parse
#define yylex           interval_lex
#define yyerror         interval_error
#define yydebug         interval_debug
#define yynerrs         interval_nerrs
#define yylval          interval_lval
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_entree = 9,                     /* entree  */
  YYSYMBOL_nombre = 10,                    /* nombre  */
  YYSYMBOL_S = 11                          /* S  */
};
...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined INTERVAL_STYPE_IS_TRIVIAL && INTERVAL_STYPE_IS_TRIVIAL)))
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "OPEN",
  "CLOSE", "COMA", "MINUS", "$accept", "entree", "nombre", "S", YY_NULLPTR
};
...
#define yyclearin       (yychar = INTERVAL_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use INTERVAL_error or INTERVAL_UNDEF. */
#define YYERRCODE INTERVAL_UNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = INTERVAL_EMPTY; /* Cause a token to be read.  */
...
yybackup:
  ...
  if (yychar <= INTERVAL_EOF)
    {
      yychar = INTERVAL_EOF;
      yytoken = YYSYMBOL_YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else if (yychar == INTERVAL_error)
    {
      /* The scanner already issued an error message, process directly
         to error recovery.  But do not keep the error token as
         lookahead, it is too special and may lead us to an endless
         loop in error recovery. */
      yychar = INTERVAL_UNDEF;
...
#line 41 "parser_interval.y"
    { 
        ...
        if (resultat_intervalle != NULL) {
            resultat_intervalle->a = (yyvsp[-3].doubleval);
...
yyerrlab:
  ...
  yytoken = yychar == INTERVAL_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
