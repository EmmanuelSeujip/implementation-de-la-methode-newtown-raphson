...
# Fichiers generés par Bison et Flex
...
# Tous les .c du projet (hors generés)
SRCS = main.c \
       utils/tree/tree.c \
...
clean:
	rm -f $(OBJS) $(TARGET) \
	      parse/function/parser.tab.c  parse/function/parser.tab.h  parse/function/lex.yy.c \
	      parse/intervalle/parser_interval.tab.c parse/intervalle/parser_interval.tab.h parse/intervalle/lex.interval_.c
